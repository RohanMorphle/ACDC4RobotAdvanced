...
def get_mjcf_mesh(link: Link) -> Element:
    ...
    file_name: str = "meshes/" + link.get_name() + ".obj"
    # STL: 0.01, OBJ: 0.1 (10x larger)
    scale_factor = "0.1 0.1 0.1" if link.mesh_format == "obj" else "0.01 0.01 0.01"
    mesh_ele.attrib = {"name":name, "file": file_name, "scale": scale_factor}
    return mesh_ele
